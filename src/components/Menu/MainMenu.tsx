...
export function MainMenu() {
  ...
  return (
    <div className="absolute inset-0 z-10 flex items-center justify-center p-5 sm:p-8 pointer-events-none">
      <div className="pointer-events-auto bg-surface/80 backdrop-blur-2xl border border-white/[0.06] rounded-3xl px-10 sm:px-16 py-12 sm:py-14 max-w-2xl w-full shadow-[0_8px_60px_rgba(6,182,212,0.08)] max-h-[calc(100dvh-2.5rem)] sm:max-h-[calc(100dvh-4rem)] overflow-y-auto animate-menu-enter">
